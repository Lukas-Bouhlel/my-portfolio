    ...
    <section class="about">
        <div class="container" @mousemove="moveImage" ref="tiltImageWrapper">
            ...
            <div class="container-text">
                <h2>About me</h2>
                <p>I have forged my expertise within several renowned schools, notably at the School of Computer Science and Advanced Techniques Epitech, where I acquired a strong foundation. Currently, I am continuing my learning journey at Cloud Campus, where I am further refining my skills and exploring the latest advancements in the field...</p>
                <a href="#">
